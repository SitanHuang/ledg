function fs_read_budgets_from_string(str) {
  ...
  for (let line of lines)
    entry = fs_read_budget_proc_line(entry,
                                     line,
                                     commitEntry,
