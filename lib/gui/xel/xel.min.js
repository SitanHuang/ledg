...
`;
  ...
  class XDocTabsElement extends HTMLElement {
      ...
      return new Promise( async (resolve) => {
        ...
        if (tab.selected) {
          ...
          if (nextTab) {
            ...
            if (nextTab.tabView) nextTab.tabView.onShow();
          }
          else if (previousTab) {
            previousTab.selected = true;
            if (previousTab.tabView) previousTab.tabView.onShow();
          }
        }
        ...
        if (tab.tabView) tab.tabView.onClose();
    ...
    selectTab(nextTab) {
      ...
      if (currentTab) {
        if (currentTab.tabView) currentTab.tabView.onHide();
