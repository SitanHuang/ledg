async function cmd_version() {
  console.log(c.bold('ledg') + '- version ' + c.bold('1.0.0-beta.1') +
...
**FLAGS**
        ...
        --include-prices=A,B,C
                ex: --include-prices=major_events.ledg
                load listed external book files (see doNotWrite documentation)
        ...
        account filter
                ...
                ledg support fuzzy search of account names
                  ...
                  * - matches any character
                  ...
                  ex: (e.ess.(gro|pcare|health.(equip|drug)|other)*)|(.diff*)|(..leisure.)
...
**VIRTUAL ENTRIES**
        Entries are virtual with the virt:true modifier.
        Pass --real flag ignores these virtual entries.

**MANUAL ENTRIES**
        Entries with the doNotWrite:true modifier are excluded from being written to file.
        File paths inside the array of "data"."include" will be loaded with the modifer
        set to true.

        Files in "data"."include" will be read with *uuid-reassigned-warning warnings
        turned off.
...
**COMMANDS**
        ...
        burndown [--q1="[<filters>] <account filters>", --q2=...] [--abs=false] [--count]
                ...
                Advanced filtering example:
                  ledg burn --q1="(e.ess.(gro|pcare|health.(equip|drug))*)|(..uber)"
