async function cmd_version() {
  console.log(c.bold('ledg - version 0.4.0') + ' built for cli');
}
...
\t        [--yearly] [ <account filter 1> <account filter 2> ... ]
...
\t       [--set-mod=A:123,B:123] [--remove-mod=C,D,E] [-y] [description]
...
\tbudget [--budget=NAME] [--do-not-adjust] [edit]
